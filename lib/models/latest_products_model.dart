...
//
//     final latestProducts = latestProductsFromJson(jsonString);

import 'dart:convert';

LatestProducts latestProductsFromJson(String str) => LatestProducts.fromJson(json.decode(str));

String latestProductsToJson(LatestProducts data) => json.encode(data.toJson());
...
class LatestProducts {
  ...
  int recordsTotal;
  int recordsFiltered;
  List<LatestProductsDatum> data;

  factory LatestProducts.fromJson(Map<String, dynamic> json) => LatestProducts(
    draw: json["draw"],
    recordsTotal: json["recordsTotal"],
    recordsFiltered: json["recordsFiltered"],
    data: List<LatestProductsDatum>.from(json["data"].map((x) => LatestProductsDatum.fromJson(x))),
  );
...
class LatestProductsDatum {
  ...
  factory LatestProductsDatum.fromJson(Map<String, dynamic> json) => LatestProductsDatum(
    id: json["id"],
    name: json["name"],
