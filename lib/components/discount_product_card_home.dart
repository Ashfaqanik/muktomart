...
class DiscountProductCardHome extends StatefulWidget {
  const DiscountProductCardHome({
    Key key,
    this.width = 140,
  ...
  final DiscountProductsDatum product;

  @override
  _DiscountProductCardHomeState createState() => _DiscountProductCardHomeState();
}

class _DiscountProductCardHomeState extends State<DiscountProductCardHome> {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget.product.name,
                      style: TextStyle(color: Colors.black,fontSize: size.width*.032),
                      maxLines: 2,
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
