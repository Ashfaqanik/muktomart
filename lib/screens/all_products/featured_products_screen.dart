...
import 'package:mukto_mart/components/featured_product_card.dart';
...
class FeaturedProductsScreen extends StatefulWidget {
  ...
  FeaturedProductsScreen({this.name});
...
class _FeaturedProductsScreenState extends State<FeaturedProductsScreen> {
  int count=0;
  Future<void> _fetch(FeaturedProductsProvider provider){
    provider.featuredlist.clear();
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    ...
    return SmartRefresher(
      ...
      child: provider.featuredProducts==null
          ?Center(child: CupertinoActivityIndicator())
          :
      // GridView.builder(
      //   shrinkWrap: true,
      //   physics: new ClampingScrollPhysics(),
      //   itemCount: provider.featuredlist.length,
      ...
      //     return FeaturedProductCard(product: provider.featuredlist[index]);
      //     // return SizedBox
  ...
  Future<void> _onLoading(FeaturedProductsProvider provider) async{
