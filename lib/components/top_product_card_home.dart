...
class TopProductCardHome extends StatefulWidget {
  const TopProductCardHome({
    Key key,
  ...
  final TopProductsDatum product;

  @override
  _TopProductCardHomeState createState() => _TopProductCardHomeState();
}

class _TopProductCardHomeState extends State<TopProductCardHome> {
