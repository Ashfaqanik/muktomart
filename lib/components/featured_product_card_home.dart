...
class FeaturedProductCardHome extends StatefulWidget {
  const FeaturedProductCardHome({
    Key key,
    this.width = 140,
  ...
  final FeaturedProductsDatum product;

  @override
  _FeaturedProductCardHomeState createState() => _FeaturedProductCardHomeState();
}

class _FeaturedProductCardHomeState extends State<FeaturedProductCardHome> {
