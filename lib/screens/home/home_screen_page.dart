...
class _HomeScreenPageState extends State<HomeScreenPage> {
  ...
  Future<void> _fetch(CartProvider cartProvider,ProfileProvider profileProvider,
      ...
      HotProductsProvider hotProductsProvider,BigProductsProvider bigProductsProvider,BannerProvider bannerProvider,SliderProvider sliderProvider,
      FeaturedSettingsProvider featuredSettingsProvider,BulkOrderProvider bulkOrderProvider,ShippingChargeProvider shippingChargeProvider)async{
    setState(()=> _counter++);
    ...
    if(shippingChargeProvider.countryList==null)await shippingChargeProvider.fetchCountries();
    if(shippingChargeProvider.stateList==null)await shippingChargeProvider.fetchStates1();
    if(shippingChargeProvider.cityList==null)await shippingChargeProvider.fetchCities1();
  ...
  Widget build(BuildContext context) {
    ...
    if(_counter==0) _fetch(cartProvider,profileProvider, wishProvider,favouriteSellerProvider,orderProvider,messagesProvider,saleProductsProvider,
        ...
        featuredSettingsProvider,bulkOrderProvider,shippingChargeProvider);
    ...
    switch (_selectedIndex) {
      ...
      case 2:
        ...
        break;
      case 3:
        userId==null?widget =Body():widget =ProfileScreenWidget();
        break;
    }
    return WillPopScope(
      onWillPop: _onBackPressed,
      child: Scaffold(
        drawer: _selectedIndex==0?new Drawer(
          child: new ListView(
            children: <Widget>[
//            header
              new UserAccountsDrawerHeader(
                accountName: profileProvider.userProfile!=null?profileProvider.userProfile.user!=null?Text('${profileProvider.userProfile.user.name??''}'):Text('No User'):Text('No User'),
                accountEmail: profileProvider.userProfile!=null?profileProvider.userProfile.user!=null?Text('${profileProvider.userProfile.user.email??''}'):Text(''):Text(''),
...
//            body
              ...
              userId==''?Container():userId==null?Container():InkWell(
                ...
                child: ListTile(
                  title: Text('Log out'),
                  leading: Icon(FontAwesomeIcons.signOutAlt, color: Colors.grey,),
                ),
              ),
