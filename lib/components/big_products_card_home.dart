...
class BigProductCardHome extends StatefulWidget {
  const BigProductCardHome({
    Key key,
    this.width = 140,
  ...
  final BigProductsDatum product;

  @override
  _BigProductCardHomeState createState() => _BigProductCardHomeState();
}

class _BigProductCardHomeState extends State<BigProductCardHome> {
