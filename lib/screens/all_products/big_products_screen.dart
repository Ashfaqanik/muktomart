...
import 'package:mukto_mart/components/big_product_card.dart';
import 'package:mukto_mart/providers/big_products_provider.dart';
import 'package:provider/provider.dart';
import 'package:flutter_staggered_grid_view/flutter_staggered_grid_view.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class BigProductsScreen extends StatefulWidget {
  String name;

  BigProductsScreen({this.name});

  @override
  _BigProductsScreenState createState() => _BigProductsScreenState();
}

class _BigProductsScreenState extends State<BigProductsScreen> {
  int count=0;
  Future<void> _fetch(BigProductsProvider provider){
    provider.list.clear();
...
class _BodyState extends State<Body> {
    ...
    return SmartRefresher(
      ...
      child: provider.list==null
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return BigProductCard(product: provider.list[index]);
          // return SizedBox
  ...
  Future<void> _onLoading(BigProductsProvider provider) async{
