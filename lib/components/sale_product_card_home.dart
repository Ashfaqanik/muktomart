...
class SaleProductCardHome extends StatefulWidget {
  const SaleProductCardHome({
    Key key,
    this.width = 140,
  ...
  @override
  _SaleProductCardHomeState createState() => _SaleProductCardHomeState();
}

class _SaleProductCardHomeState extends State<SaleProductCardHome> {
