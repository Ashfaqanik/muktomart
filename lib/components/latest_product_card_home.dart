...
class LatestProductCardHome extends StatefulWidget {
  const LatestProductCardHome({
    Key key,
    this.width = 140,
  ...
  final LatestProductsDatum product;

  @override
  _LatestProductCardHomeState createState() => _LatestProductCardHomeState();
}

class _LatestProductCardHomeState extends State<LatestProductCardHome> {
