...
class HotProductCardHome extends StatefulWidget {
  const HotProductCardHome({
    Key key,
    this.width = 140,
  ...
  final HotProductsDatum product;

  @override
  _HotProductCardHomeState createState() => _HotProductCardHomeState();
}

class _HotProductCardHomeState extends State<HotProductCardHome> {
