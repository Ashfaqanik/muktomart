...
class FeatureSettingCard1 extends StatefulWidget {
  final Datum product;

  const FeatureSettingCard1({Key key, @required this.product}) : super(key: key);


  @override
  _FeatureSettingCard1State createState() => _FeatureSettingCard1State();
}

class _FeatureSettingCard1State extends State<FeatureSettingCard1> {
