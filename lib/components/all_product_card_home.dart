...
class AllProductCardHome extends StatefulWidget {
  const AllProductCardHome({
    Key key,
    this.width = 140,
  ...
  @override
  _AllProductCardHomeState createState() => _AllProductCardHomeState();
}

class _AllProductCardHomeState extends State<AllProductCardHome> {
