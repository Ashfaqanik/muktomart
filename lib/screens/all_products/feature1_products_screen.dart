...
//
// class Feature1ProductsScreen extends StatefulWidget {
//   String name;
//
//   Feature1ProductsScreen({this.name});
//
//   @override
//   _Feature1ProductsScreenState createState() => _Feature1ProductsScreenState();
// }
//
// class _Feature1ProductsScreenState extends State<Feature1ProductsScreen> {
//   int count=0;
//   Future<void> _fetch(FeaturedSettingsProvider provider){
//     provider.productList1.isNotEmpty?provider.productList1.clear():null;
//     provider.fetch1List().then((value){
//       setState(() {
//         count++;
//       });
//     });
...
//     final FeaturedSettingsProvider provider = Provider.of<FeaturedSettingsProvider>(context);
//
//     return provider.productListFeature1!=null?provider.productListFeature1.data.isNotEmpty?SmartRefresher(
//         enablePullDown: true,
//         enablePullUp: true,
...
//         child: provider.productList1==null
//             ?Center(child: CupertinoActivityIndicator())
//             :
//         // GridView.builder(
//         //     shrinkWrap: true,
//         //     physics: new ClampingScrollPhysics(),
//         //     itemCount: provider.productList1.length,
...
//         //       return FeatureSettingCard1(product: provider.productList1[index]);
//         //       // return SizedBox
...
//     await provider.fetch1Page(page).then((value){
